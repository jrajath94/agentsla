...
[![Release v1.0.0](https://img.shields.io/badge/release-v1.0.0-blue)](https://github.com/jrajath94/agentsla/releases/tag/v1.0.0)
...
Runs 35 tasks across financial ops, incident triage, and doc QA (5 injection-payload variants embedded) in wrapped and unwrapped modes × 2 seeds. Outputs TTFT latency overhead, cost overhead, and verification recovery rate.
